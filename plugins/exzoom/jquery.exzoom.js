;(function ($, window) {
    ...
    function init() {
        ...
        g.exzoom_nav_innerWidth = (120 + g.navItemMargin) * imgNum;
        
        

        exzoom_navSpan.eq(imgIndex).addClass(navHightClass);
        exzoom_nav.css({
            "height": navHeightWithBorder + 20 + "px",
            "width": boxWidth - exzoom_prev_btn.width() - exzoom_next_btn.width() - 18,
            "left":"25px"
        });
...
<p class='exzoom_preview'>
    ...
    function bindingEvent() {
        ...
        exzoom_zoom_outer.on("mouseenter", function () {
            ...
            exzoom_zoom.css("border", "1px solid rgb(0,0,0)");
        ...
        exzoom_zoom_outer.on("mousemove", function (e) {
            ...
            exzoom_zoom.css({"left": move_X + "px", "top": 0 + "px"});
    ...
    function move(direction) {
        ...
        if (temp > exzoom_nav_width) {
            new_nav_offset =  boxWidth - temp - 30;
        }
        ...
        new_position = checkNewPositionLimit(new_position);
        exzoom_img_ul.stop().animate({"left": new_position}, 600);
        //处理放大区域
        previewImg(imgArr[imgIndex]);
    }
    ...
    function copute_image_prop(image, width, height) {
        ...
        if (img_scale === 1) {
            ...
            res[6] = 0;//left
            res[7] = res[4] / 2;
            res[8] = boxWidth * 2 * img_scale;//width
            res[9] = boxHeight * 2;//height
